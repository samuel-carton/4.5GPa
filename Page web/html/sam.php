...
<script>
    ...
    var primaryQuestion = [4.1,12.2,13.2,39.1,62.2,70.1,72.1];
    var questionTable = [  [5.1,6.1,6.2,6.3,7.1,7.2,7.3,8.1,8.2,8.3,9.1,9.2,9.3,10.1,10.2,10.3,11.1,11.2,11.3,11.4],
                         ...
                         [64.1,64.2,64.3,65.1,65.2,65.3,66.1,66.2,66.3,67.1,67.2,67.3,68.1,68.2,68.3,69.1,69.2,69.3], [70.2], [72.2]];
    var listenerTable=[];
