<form name="questionnaire_agit" action="" method="post">
           <input  type="submit"  value="save" name="save"><input  type="submit"  value="submit" name="submit">
            ...
            <select class="form-control" name="1">
                ...
                echo '<option value="form" selected disabled hidden>Choose here</option>';
                ?> 
            ...
            <p>4. Do you develop digital services for international or external use (sales to customer)?</p> 
             ...
             <?php 
                echo 'Saved:';
                echo '<input type="radio" name="4" id="4.1" value="yes" checked/>'.'SavedValue'.' | ';
            ?>  
            ...
            <?php 
                echo '<input disabled = true id="5.1" class="form-control" type="text" name="5" size="10" value="FormValue" />';
            ?>  
            ...
            <input disabled = true id="11.4" placeholder="TB" type="text" name="11_3"/> 
            ...
            <input disabled = true class="form-control" placeholder="m&sup2;" type="text" name="15_3"/>   
            ...
            <input type="radio" name="70" value="70_1"/> Yes
            <p>If yes, please specify how much in kWh per year </p>
            <input class="form-control" type="text" name="70_1" value="0"/> kWh per year
            ...
            <input type="radio" name="72" value="72_1"/> Yes
            If yes, please specify how much in % 
            <input class="form-control" type="text" name="72_1" value="0"/> 
            ...
            <input class="form-control" type="text" name="87_5" value="text" maxlength="20">
